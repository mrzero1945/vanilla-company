...
import EmailIcon from "../resources/email-icon2.png";
...
const Contact = () => {
  const social_media_names = [
    ...
    },
    {
      ...
      link: "https://www.facebook.com/share/1DfZ58J2Ku/?mibextid=wwXIfr",
    },
    {
      id:3,
      name: "TikTok",
      path: "M21,2H3A1,1,0,0,0,2,3V21a1,1,0,0,0,1,1H21a1,1,0,0,0,1-1V3A1,1,0,0,0,21,2Zm-3.281,8.725h0c-.109.011-.219.016-.328.017A3.571,3.571,0,0,1,14.4,9.129v5.493a4.061,4.061,0,1,1-4.06-4.06c.085,0,.167.008.251.013v2a2.067,2.067,0,1,0-.251,4.119A2.123,2.123,0,0,0,12.5,14.649l.02-9.331h1.914A3.564,3.564,0,0,0,17.719,8.5Z",
      link: "https://www.tiktok.com/@exquisite.nusanta?_t=8sP1W6spsyP&_r=1"
    },
    {
      id:4,
      name: "WhatsApp",
    ...
    },
    {
      id:6,
      name: "Telegram",
      path: "M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 8.8C16.49 10.38 15.84 14.22 15.51 15.99C15.37 16.74 15.09 16.99 14.83 17.02C14.25 17.07 13.81 16.64 13.25 16.27C12.37 15.69 11.87 15.33 11.02 14.77C10.03 14.12 10.67 13.76 11.24 13.18C11.39 13.03 13.95 10.7 14 10.49C14.0069 10.4582 14.006 10.4252 13.9973 10.3938C13.9886 10.3624 13.9724 10.3337 13.95 10.31C13.89 10.26 13.81 10.28 13.74 10.29C13.65 10.31 12.25 11.24 9.52 13.08C9.12 13.35 8.76 13.49 8.44 13.48C8.08 13.47 7.4 13.28 6.89 13.11C6.26 12.91 5.77 12.8 5.81 12.45C5.83 12.27 6.08 12.09 6.55 11.9C9.47 10.63 11.41 9.79 12.38 9.39C15.16 8.23 15.73 8.03 16.11 8.03C16.19 8.03 16.38 8.05 16.5 8.15C16.6 8.23 16.63 8.34 16.64 8.42C16.63 8.48 16.65 8.66 16.64 8.8Z",
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 lg:px-12 text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg leading-relaxed text-[rgb(244,234,197)]">
    ...
    <section className="scroll-row py-16">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 px-6 lg:px-12">
        {/* Col 1: Social Media */}
        <div>
          <h2 className={`text-4xl mb-6 ${Colors.primary_text}`}>Social Media</h2>
          {social_media_names.map((social_media) => (
            <div key={social_media.id} className="mb-4">
              <a
                href={social_media.link}
                target="_blank"
                rel="noopener noreferrer"
                aria-label={social_media.name}
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  className="text-[#549688] group-hover:text-gray-400 transition-colors"
                >
                  <path d={social_media.path} fill="currentColor" />
                </svg>
                <h3 className={`pl-2 ${Colors.primary_text} text-xl`}>
                  {social_media.name}
                </h3>
              </a>
            </div>
        ...
        {/* Col 2: Company Location */}
        <div className="flex flex-col justify-center items-center text-center">
          <h2 className="text-4xl text-[rgb(84,150,136)] mb-6">Company Location</h2>
          <p className="mb-6 text-gray-700">Jakarta, Indonesia</p>
        ...
        <div className="mt-10">
          <h2 className="text-4xl text-[rgb(84,150,136)] mb-6">Contact Information</h2>
          <div className="flex items-center gap-4 mb-4">
            <Image
              ...
              className="w-8"
            />
            <span className={`${Colors.primary_text}`}>NatureExquisiteNusantara@gmail.com</span>
          </div>
          <div className="flex items-center gap-4 mb-4">
            <Image
              src={PhoneIcon.src}
              ...
              className="w-8"
            />
            <span className={`${Colors.primary_text}`}>08116668220</span>
          </div>
          <a href="https://wa.me/+628116668220" className="block">
            <div className="flex items-center gap-4 mb-4">
              <Image
                src={WaIcon.src}
                width={1000}
        ...
        <div className="mt-10">
          <h2 className={`text-4xl text-center ${Colors.primary_text}`}>Customer Service</h2>
          <Image
            src={CusService.src}
          ...
          />
          <p className="text-gray-700 mx-5 mt-5 text-center">
            At PT Nature Exquisite Nusantara Export company, we prioritize your
            satisfaction by providing exceptional customer service tailored to
            your needs.
          </p>
        </div>
        ...
        {/* Col 5: Get in Touch */}
        <div>
          <button className="flex items-center gap-2 bg-[rgb(84,150,136)] text-white px-6 py-3 rounded-full font-semibold shadow-md hover:bg-[rgb(68,122,111)] transition mb-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
